...
public class URLCrawler {
    ...
    public static void main(String[] args) {
        try {
            String startingUrl = "https://www.crawler-test.com/";
            String cookie = "geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1geo_redirect_closed=1";
